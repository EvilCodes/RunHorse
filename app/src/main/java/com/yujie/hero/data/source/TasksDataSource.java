...
public interface TasksDataSource {
    ...
    void getNetWorkTuserTask(@NonNull LoadTuserCallback callback, @NonNull String uid,
                             @NonNull String pwd);
    void updateTuserTask(@NonNull UserBean userBean, @NonNull LoadTuserCallback callback);
    void updateTuserStatusTask( @NonNull String username, @NonNull LoadTuserCallback callback);
    void saveTuserTask(@NonNull UserBean user, @NonNull LoadTuserCallback callback);
    void saveExerciseGradeTask(@NonNull ExerciseBean user, @NonNull LoadExerciseGradeCallback callback);
