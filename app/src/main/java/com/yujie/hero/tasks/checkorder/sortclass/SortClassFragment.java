...
public class SortClassFragment extends Fragment implements SortClassContract.View,LineChartOnValueSelectListener{
    ...
    private SortClassPresenter mPresenter;
    private Context mContext;
    private ArrayList<ExerciseBean> personData;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new SortClassPresenter(this, TasksRemoteDataSource.getInstance());
        mPresenter.initData(HeroApplication.getInstance().getCurrentUser().getB_class() + "");
    ...
    @Override
    public void getData(ArrayList<ExerciseBean> list) {

        Log.e("SortClassFragment", "getData.list=" + list);

        adapter = new RecycleAdapter(mContext, list);
        ...
        mPresenter.initNearlyGradeData(list.get(0).getUser_name(), new RemoteDataSource.LoadExerciseGradeCallback() {
            @Override
    ...
    public void initAdapter() {
        adapter.setListener(new RecycleAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(View v, int position, ExerciseBean item) {
                ...
                mPresenter.initNearlyGradeData(item.getUser_name(), new RemoteDataSource.LoadExerciseGradeCallback() {
                    @Override
                    public void onExerciseGradeUpLoaded(Result result) {
