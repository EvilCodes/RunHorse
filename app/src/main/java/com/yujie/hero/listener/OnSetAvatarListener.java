...
public class OnSetAvatarListener implements View.OnClickListener {
    public static final String TAG = OnSetAvatarListener.class.getSimpleName();
     ...
     */
    public OnSetAvatarListener(Activity mActivity, int parentId, String userName, String avatarType,String uid) {
        //成员变量赋值
        ...
        mLayout.findViewById(R.id.canNot).setOnClickListener(this);
        //显示PopuWindow
